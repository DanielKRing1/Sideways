...
// CONTEXT
const ThemeModeContext: React.Context<ThemeModeContextValueType> =
  createContext(DEFAULT_CONTEXT_VALUE);
...
const getModeTheme = (
  possibleThemes: ModeThemes,
  mode: ThemeMode,
): DefaultTheme => possibleThemes[mode];
