...
export const readGraph = createSlice({
    ...
    initialState,
    reducers: {
        setInputSelections: (state: ReadGraphState, action: SetInputSelectionAction) => {
            state.inputSelections = action.payload;
        },
        setOutputSelections: (state: ReadGraphState, action: SetOutputSelectionAction) => {
            state.outputSelections = action.payload;
        },
        forceSignatureRerender: (state: ReadGraphState, action: ForceRatingsRerenderAction) => {
...
export const { setInputSelections, setOutputSelections, forceSignatureRerender } = readGraph.actions;
